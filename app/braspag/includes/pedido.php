<?php
	...
	class Pedido
	{
		...
		public function Enviar($vmPost, $transacao)
		{
			...
			if($vmResposta['res']==0){
			$ret = simplexml_load_string($vmResposta['xml']);
			}else{
			$ret = "Problema de conex&atilde;o no ambiente ".ENDERECO.", cod de resposta: ".$vmResposta['xml']."";
			}
			
			if(LOG_CIELO=='SIM'){
			$this->logger->logWrite("RESPOSTA: " . $vmResposta['xml'], $transacao);
			}
		...
		public function getLr()
		{
			...
			switch($this->lrcod)
			{
				...
				case "62":
				case "63":
				$lrcod = $this->lrcod." - Transacao referida/com restricao pelo emissor (Contate o emissor de seu cartao)";
				break;
				case "05": 
				...
				case "12": 
				case "82": 
				$lrcod = $this->lrcod." - Transacao invalida";
				break;
				case "13": 
				...
				case "57": 
				case "58":
				$lrcod = $this->lrcod." - Transacao nao permitida";
				break;
				case "78":
