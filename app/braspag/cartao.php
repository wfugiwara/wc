...
$laco_mes1 = SomarDatas($data_hoje, 0, 0, 0);
$db->query("INSERT INTO `braspag_itens` (`idItem`, `idPedido`, `dataDebito`, `statusPagamento`, `valorPago`, `numPag`, `dadosPag`) VALUES (NULL, '".$pedido_id."', '".$laco_mes1."', '6', '".number_format($valor_pagar, 2, '.', '')."', '1', '');");
$laco_mes2 = SomarDatas($data_hoje, 0, 6, 0);
$db->query("INSERT INTO `braspag_itens` (`idItem`, `idPedido`, `dataDebito`, `statusPagamento`, `valorPago`, `numPag`, `dadosPag`) VALUES (NULL, '".$pedido_id."', '".$laco_mes2."', '6', '".number_format($valor_pagar, 2, '.', '')."', '2', '');");
