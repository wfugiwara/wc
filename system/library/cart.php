...
class Cart {
				...
				if ($product_query->num_rows) {
					...
					foreach ($options as $product_option_id => $option_value) {
						...
						// adiciona renavans						
							...
							$option_data[] = array(
								'product_option_id'       => $contador,
								'product_option_value_id' => '',
								'option_id'               => $contador,
								'option_value_id'         => '',
								'name'                    => 'Renavam do veículo '.($contador+1),
								'option_value'            => $option_value,
								'type'                    => 'text',
								'quantity'                => '',
								'subtract'                => '',
	...
	// alteração antonio
	// função que adiciona renavans
	public function renavam($product_id, $keyvelho, $qty, $option = array()) {
		unset($this->session->data['cart'][$keyvelho]);
