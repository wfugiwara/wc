...
.ui-dialog.ui-overlay-a {
	border: 1px solid 		<?php echo $mobile_custom_styles['Content_body_border'];?> /*{a-body-border}*/;
...
-----------------------------------------------------------------------------------------------------------*/
.ui-bar-b {
	<?php /*?>border: 1px solid 		<?php echo $mobile_custom_styles['Header_footer_border'];?> <?php */?>/*{b-bar-border}*/
...
.ui-bar-c {
	border: 1px solid 		<?php echo $mobile_custom_styles['Header_footer_border'];?> /*{c-bar-border}*/;
...
.ui-icon-searchfield:after {
	background: 						<?php echo $mobile_custom_styles['Corner_Radii_group'];?> /*{global-icon-color}*/;
