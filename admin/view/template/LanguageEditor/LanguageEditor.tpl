...
*/
    ...
    //+--------------------------------------------------------------------------------------+
    //              Checks if the FILE parameter is being passed via URL                     |
    //                    and sets the header of the page if so.                             |
    //+--------------------------------------------------------------------------------------+
                                        ...
                                        <tr>
                                         ...
                                         <td class="left">
                                          <form id = "updateform" action = "<?PHP echo $viewing_file_link; ?>" method = "POST">
                                           <textarea name = "strvalue" cols = "200" rows = "20"><?PHP echo $file_vars[$string]; ?></textarea>
