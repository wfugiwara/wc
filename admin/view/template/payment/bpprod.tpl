<?php echo $header; ?>
<?php
$meios_cartao = array(0=>'Amex 2P',1=>'Visa TEF',2=>'Amex TEF',3=>'RedeCard WebService',28=>'Visa EDI',30=>'Mastercard TEF',31=>'Diners TEF',34=>'Visa Moset 1',41=>'Hipercard',71=>'Visa',120=>'Mastercard');
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
		 ...
		 <tr>
            ...
            <td><input type="text" name="bpprod_nome" value="<?php echo $bpprod_nome; ?>" size="70" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_total; ?></td>
            <td><input class="dinheiro" type="text" name="bpprod_total" value="<?php echo $bpprod_total; ?>" /></td>
          </tr> 
          ...
          <tr>
            ...
            <td><select name="bpprod_geo_zone_id">
                <option value="0"><?php echo $text_all_zones; ?></option>
                <?php foreach ($geo_zones as $geo_zone) { ?>
                <?php if ($geo_zone['geo_zone_id'] == $bpprod_geo_zone_id) { ?>
          ...
          <tr>
            ...
            <td><select name="bpprod_status">
                <?php if ($bpprod_status) { ?>
          ...
          <tr>
            ...
            <td><input type="text" name="bpprod_sort_order" value="<?php echo $bpprod_sort_order; ?>" size="1" /></td>
          </tr>
		   <tr>
            <td>Ambiente:<span class="help">De acordo seu uso.</span></td>
            <td><select name="bpprod_ambiente">
                <?php if ($bpprod_ambiente==1) { ?>
		  ...
		  <tr>
            ...
            <td><input type="text" name="bpprod_chave" value="<?php echo $bpprod_chave; ?>" size="70" /></td>
          </tr>
		  ...
		  <tr>
            ...
            <td><select name="bpprod_order_status_id">
                <?php foreach ($order_statuses as $order_status) { ?>
                <?php if ($order_status['order_status_id'] == $bpprod_order_status_id) { ?>
		  ...
		  <tr>
            ...
            <td><select name="bpprod_autorizado">
                <?php foreach ($order_statuses as $order_status) { ?>
                <?php if ($order_status['order_status_id'] == $bpprod_autorizado) { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                <?php } ?>
		  ...
		  <tr>
            ...
            <td><select name="bpprod_aprovado">
                <?php foreach ($order_statuses as $order_status) { ?>
                <?php if ($order_status['order_status_id'] == $bpprod_aprovado) { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                <?php } ?>
		  ...
		  <tr>
            ...
            <td><select name="bpprod_cancelado">
                <?php foreach ($order_statuses as $order_status) { ?>
                <?php if ($order_status['order_status_id'] == $bpprod_cancelado) { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                <?php } ?>
		  ...
		  <tr>
            ...
            <td>
				<select name="bpprod_cc[]" size="10" multiple>
                <?php foreach ($meios_cartao as $id => $nome) { ?>
                <?php if (in_array($id,$bpprod_cc)) { ?>
                <option value="<?php echo $id; ?>" selected="selected"><?php echo $id; ?> - <?php echo $nome; ?></option>
                <?php } else { ?>
                <option value="<?php echo $id; ?>"><?php echo $id; ?> - <?php echo $nome; ?></option>
                <?php } ?>
