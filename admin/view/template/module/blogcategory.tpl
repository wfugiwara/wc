                        ...
                        <td class="center">
                           <table class="left" width="100%">
                              <tr>
                                 ...
                                 <td><input type="text" name="blogcategory_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" /></td>
                              </tr>
                              <tr>
                                 <td><?php echo $entry_count; ?></td>
                                 <td>
                                    <select name="blogcategory_module[<?php echo $module_row; ?>][count]">
                                       <?php if ($module['count']) { ?>
                              ...
                              <tr>
                                 ...
                                 <td class="input_125"><input type="text" name="blogcategory_module[<?php echo $module_row; ?>][exclude]" value="<?php echo (isset($module['exclude']) && $module['exclude']) ? $module['exclude'] : ''; ?>" /></td>
                              </tr>
                           </table>
                        </td>
                        <td class="center design">
                           <table class="left" width="100%">
                              <tr>
                                 ...
                                 <td>
                                    <select name="blogcategory_module[<?php echo $module_row; ?>][layout_id]">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <select name="blogcategory_module[<?php echo $module_row; ?>][position]">
                              ...
                              <tr>
                                 <td class="entry"><?php echo $entry_suffix; ?></td>
                                 <td class="input_165">
                                    <input type="text" name="blogcategory_module[<?php echo $module_row; ?>][suffix]" value="<?php echo $module['suffix']; ?>" />
                                 </td>
                              </tr>
                           </table>
                        </td>
                        <td class="center">
                           <select name="blogcategory_module[<?php echo $module_row; ?>][status]">
...
function addModule() {   
   ...
   html += '               <td><input type="text" name="blogcategory_module[' + module_row + '][sort_order]" value="" /></td>';
   html += '            </tr>';
   html += '            <tr>';
   html += '               <td><?php echo $entry_count; ?></td>';
   html += '               <td>';
   html += '                  <select name="blogcategory_module[' + module_row + '][count]">';
   ...
   html += '               <td class="input_125"><input type="text" name="blogcategory_module[' + module_row + '][exclude]" value="" /></td>';
   html += '            </tr>';
   html += '         </table>';
   html += '      </td>';
   ...
   html += '               <td>';
   html += '                  <select name="blogcategory_module[' + module_row + '][layout_id]">';
                           <?php foreach ($layouts as $layout) { ?>
   ...
   html += '               <td><select name="blogcategory_module[' + module_row + '][position]">';
   ...
   html += '               <td class="input_165"><input type="text" name="blogcategory_module[' + module_row + '][suffix]" value="boxPlain" /></td>';
   html += '            </tr>';
   html += '         </table>';
   html += '      </td>';
   html += '      <td class="center">';
   html += '         <select name="blogcategory_module[' + module_row + '][status]">';
   html += '               <option value="1" selected="selected"><?php echo $text_enabled; ?></option>';
   html += '               <option value="0"><?php echo $text_disabled; ?></option>';
   html += '         </select>';
   html += '      </td>';
