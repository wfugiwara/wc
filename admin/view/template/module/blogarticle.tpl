                        ...
                        <td class="center">
                           <table class="left" width="100%">
                              <tr>
                                 ...
                                 <td class="td2nd"><input type="text" name="blogarticle_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" /></td>
                                 <td class="entry"><?php echo $entry_limit; ?></td>
                                 <td><input type="text" name="blogarticle_module[<?php echo $module_row; ?>][limit]" value="<?php echo $module['limit']; ?>" /></td>
                              </tr>
                              <tr>
                                 <td><?php echo $entry_image; ?></td>
                                 <td>
                                    <input type="text" name="blogarticle_module[<?php echo $module_row; ?>][image_width]" value="<?php echo $module['image_width']; ?>" /> x 
                                    <input type="text" name="blogarticle_module[<?php echo $module_row; ?>][image_height]" value="<?php echo $module['image_height']; ?>" />
                                    <?php if (isset($error_image[$module_row])) { ?>
                                       <span class="error"><?php echo $error_image[$module_row]; ?></span>
                                    <?php } ?>
                                 </td>
                                 <td><?php echo $entry_description; ?></td>
                                 <td><input type="text" name="blogarticle_module[<?php echo $module_row; ?>][description]" value="<?php echo $module['description']; ?>" /></td>
                              </tr>
                              <tr>
                                 <td><?php echo $entry_exclude; ?></td>
                                 <td class="input_125"><input type="text" name="blogarticle_module[<?php echo $module_row; ?>][exclude]" value="<?php echo $module['exclude']; ?>" /></td>
                                 <td><?php echo $entry_spesific; ?></td>
                                 <td><input type="text" name="blogarticle_module[<?php echo $module_row; ?>][spesific]" value="<?php echo $module['spesific']; ?>" /></td>
                              </tr>
                           </table>
                        </td>
                        <td class="center">
                           <table class="left" width="100%">
                              <tr>
                                 ...
                                 <td>
                                    <select name="blogarticle_module[<?php echo $module_row; ?>][layout_id]">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <select name="blogarticle_module[<?php echo $module_row; ?>][position]">
                              ...
                              <tr>
                                 ...
                                 <td class="input_190">
                                    <input type="text" name="blogarticle_module[<?php echo $module_row; ?>][suffix]" value="<?php echo $module['suffix']; ?>" />
                                 </td>
                              </tr>
                           </table>
                        </td>
                        <td class="center"><select name="blogarticle_module[<?php echo $module_row; ?>][status]">
...
function addModule() {
   ...
   html += '               <td class="td2nd"><input type="text" name="blogarticle_module[' + module_row + '][sort_order]" value="" /></td>';
   html += '               <td class="entry"><?php echo $entry_limit; ?></td>';
   html += '               <td><input type="text" name="blogarticle_module[' + module_row + '][limit]" value="5" /></td>';
   html += '            </tr>';
   html += '            <tr>';
   html += '               <td><?php echo $entry_image; ?></td>';
   html += '               <td class="input_40">';
   html += '                  <input type="text" name="blogarticle_module[' + module_row + '][image_width]" value="45" /> x ';
   html += '                  <input type="text" name="blogarticle_module[' + module_row + '][image_height]" value="45" />';
   html += '               </td>';
   html += '               <td><?php echo $entry_description; ?></td>';
   html += '               <td><input type="text" name="blogarticle_module[' + module_row + '][description]" value="0" /></td>';
   html += '            </tr>';
   html += '            <tr>';
   html += '               <td><?php echo $entry_exclude; ?></td>';
   html += '               <td class="input_125"><input type="text" name="blogarticle_module[' + module_row + '][exclude]" value="" /></td>';
   html += '               <td><?php echo $entry_spesific; ?></td>';
   html += '               <td><input type="text" name="blogarticle_module[' + module_row + '][spesific]" value="0" /></td>';
   html += '            </tr>';
   html += '         </table>';
   html += '      </td>';
   html += '      <td class="center">';
   ...
   html += '               <td>';
   html += '                  <select name="blogarticle_module[' + module_row + '][layout_id]">';
      <?php foreach ($layouts as $layout) { ?>
   ...
   html += '               <td>';
   html += '                  <select name="blogarticle_module[' + module_row + '][position]">';
   ...
   html += '               <td class="input_190">';
   html += '                  <input type="text" name="blogarticle_module[' + module_row + '][suffix]" value="boxPlain" />';
   html += '               </td>';
   html += '            </tr>';
   html += '         </table>';
   html += '      </td>';
   html += '      <td class="center"><select name="blogarticle_module[' + module_row + '][status]">';
