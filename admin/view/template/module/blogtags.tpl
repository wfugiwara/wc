               ...
               <?php foreach ($modules as $module) { ?>
                  ...
                  <tbody id="module-row<?php echo $module_row; ?>" class="<?php echo $class; ?>">
                     <tr>
                        <td class="center">
                           <table class="left" width="100%">
                              <tr>
                                 ...
                                 <td class="td2nd"><input type="text" name="blogtags_module[<?php echo $module_row; ?>][limit]" value="<?php echo $module['limit']; ?>" /></td>
                                 <td class="entry"><?php echo $entry_sort_order; ?></td>
                                 <td><input type="text" name="blogtags_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" /></td>
                              </tr>
                              <tr>
                                 <td><?php echo $entry_suffix; ?></td>
                                 <td colspan="3" class="input_190">
                                    <input type="text" name="blogtags_module[<?php echo $module_row; ?>][suffix]" value="<?php echo $module['suffix']; ?>" />
                                 </td>
                              </tr>
                           </table>
                        </td>
                        <td class="center">
                           <table class="left" width="100%">
                              <tr>
                                 ...
                                 <td>
                                    <select name="blogtags_module[<?php echo $module_row; ?>][layout_id]">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <select name="blogtags_module[<?php echo $module_row; ?>][position]">
                        ...
                        <td class="center"><select name="blogtags_module[<?php echo $module_row; ?>][status]">
...
function addModule() {
   ...
   html += '               <td class="td2nd"><input type="text" name="blogtags_module[' + module_row + '][limit]" value="25" /></td>';
   html += '               <td class="entry"><?php echo $entry_sort_order; ?></td>';
   html += '               <td><input type="text" name="blogtags_module[' + module_row + '][sort_order]" value="" /></td>';
   html += '            </tr>';
   html += '            <tr>';
   html += '               <td><?php echo $entry_suffix; ?></td>';
   html += '               <td colspan="3" class="input_190">';
   html += '                  <input type="text" name="blogtags_module[' + module_row + '][suffix]" value="boxPlain" />';
   html += '               </td>';
   html += '            </tr>';
   html += '         </table>';
   html += '      </td>';
   ...
   html += '               <td>';
   html += '                  <select name="blogtags_module[' + module_row + '][layout_id]">';
      <?php foreach ($layouts as $layout) { ?>
   ...
   html += '               <td>';
   html += '                  <select name="blogtags_module[' + module_row + '][position]">';
   ...
   html += '         </table>';
   html += '      </td>';
   html += '      <td class="center"><select name="blogtags_module[' + module_row + '][status]">';
