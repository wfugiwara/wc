                        ...
                        <td class="center">
                           <table class="left" width="100%">
                              <tr>
                                 ...
                                 <td class="td2nd"><input type="text" name="blogcomment_module[<?php echo $module_row; ?>][limit]" value="<?php echo $module['limit']; ?>" /></td>
                                 <td class="entry"><?php echo $entry_sort_order; ?></td>
                                 <td><input type="text" name="blogcomment_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" /></td>
                              </tr>
                              <tr>
                                 <td><?php echo $entry_image; ?></td>
                                 <td colspan="3" class="input_40">
                                    <input type="text" name="blogcomment_module[<?php echo $module_row; ?>][image_width]" value="<?php echo $module['image_width']; ?>" /> x 
                                    <input type="text" name="blogcomment_module[<?php echo $module_row; ?>][image_height]" value="<?php echo $module['image_height']; ?>" />
                              ...
                              <tr>
                                 ...
                                 <td colspan="3" class="input_165">
                                    <input type="text" name="blogcomment_module[<?php echo $module_row; ?>][exclude]" value="<?php echo $module['exclude']; ?>" />
                                 </td>
                              </tr>
                           </table>
                        </td>
                        <td class="center">
                           <table class="left" width="100%">
                              <tr>
                                 ...
                                 <td>
                                    <select name="blogcomment_module[<?php echo $module_row; ?>][layout_id]">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <select name="blogcomment_module[<?php echo $module_row; ?>][position]">
                              ...
                              <tr>
                                 ...
                                 <td class="input_165">
                                    <input type="text" name="blogcomment_module[<?php echo $module_row; ?>][suffix]" value="<?php echo $module['suffix']; ?>" />
                                 </td>
                              </tr>
                           </table>
                        </td>
                        <td class="center"><select name="blogcomment_module[<?php echo $module_row; ?>][status]">
...
function addModule() {
   ...
   html += '               <td class="td2nd"><input type="text" name="blogcomment_module[' + module_row + '][limit]" value="5" /></td>';
   html += '               <td class="entry"><?php echo $entry_sort_order; ?></td>';
   html += '               <td><input type="text" name="blogcomment_module[' + module_row + '][sort_order]" value="" /></td>';
   html += '            </tr>';
   html += '            <tr>';
   html += '               <td><?php echo $entry_image; ?></td>';
   html += '               <td colspan="3" class="input_40">';
   html += '                  <input type="text" name="blogcomment_module[' + module_row + '][image_width]" value="45" /> x ';
   html += '                  <input type="text" name="blogcomment_module[' + module_row + '][image_height]" value="45" />';
   html += '               </td>';
   html += '            </tr>';
   html += '            <tr>';
   html += '               <td><?php echo $entry_exclude; ?></td>';
   html += '               <td colspan="3" class="input_165">';
   html += '                  <input type="text" name="blogcomment_module[' + module_row + '][exclude]" value="" />';
   html += '               </td>';
   html += '            </tr>';
   html += '         </table>';
   html += '      </td>';
   ...
   html += '               <td colspan="3">';
   html += '                  <select name="blogcomment_module[' + module_row + '][layout_id]">';
      <?php foreach ($layouts as $layout) { ?>
   ...
   html += '               <td  colspan="3">';
   html += '                  <select name="blogcomment_module[' + module_row + '][position]">';
   ...
   html += '               <td colspan="3" class="input_165">';
   html += '                  <input type="text" name="blogcomment_module[' + module_row + '][suffix]" value="boxPlain" />';
   html += '               </td>';
   html += '            </tr>';
   html += '         </table>';
   html += '      </td>';
   html += '      <td class="center"><select name="blogcomment_module[' + module_row + '][status]">';
