        ...
        <div id="tab-general">
          ...
          <div id="tab-address-<?php echo $address_row; ?>" class="vtabs-content">
            ...
            <table class="form">
              ...
              <input type="hidden" name="address[<?php echo $address_row; ?>][company]" value="<?php echo $address['company']; ?>" />
...
function addAddress() {	
    ...
    html += '    </tr>';
    html += '   <input type="hidden" name="address[' + address_row + '][company]" value="" />';
