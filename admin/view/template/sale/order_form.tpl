      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <table class="form">
			...
			<tr>
				<td><span class="required">*</span> Número: </td>
					<td><input type="text" name="payment_numero" value="<?php echo $payment_numero; ?>" />
        ...
        <div id="tab-shipping" class="vtabs-content">
          <table class="form">
			...
			<tr>
				<td><span class="required">*</span> Número: </td>
					<td><input type="text" name="shipping_numero" value="<?php echo $shipping_numero; ?>" />
...
$('input[name=\'customer\']').catcomplete({
	...
	select: function(event, ui) { 
		...
		$('input[name=\'telephone2\']').attr('value', ui.item['telephone2']);
		$('input[name=\'ddd2\']').attr('value', ui.item['ddd2']);
		if (ui.item['sexo']=="m"){
		...
		$('input[name=\'data_nascimento\']').attr('value', ui.item['data_nascimento']);
		...
		//$('input[name=\'placa1\']').attr('value', ui.item['placa1']);
		//$('input[name=\'placa2\']').attr('value', ui.item['placa2']);
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				if (json['error']['ddd']) {
					$('input[name=\'ddd\']').after('<span class="error">' + json['error']['ddd'] + '</span>');
				}	
				// Payment Address
