...
$_['entry_default_postcode']    = 'Default Postcode:';

$_['entry_show_country_field']  = 'Show country selection field?<span class="help">You can disable this field if your store sells in your country only.</span>';

$_['entry_show_zone_field']   = 'Show zone selection field?<span class="help">You can disable this field if your store only uses postcode based  modules, and has no shipping tax by region.</span>';
...
$_['entry_auto_quote'] = 'Auto Quote <span class="help">If enabled will automatic display estimated quote for default country / region';
