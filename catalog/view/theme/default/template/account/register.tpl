  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="content">
      <table class="form">
		...
		<tr>
          <td><span class="required">*</span> Confime o e-mail</td>
          <td>
        ...
        <tr>
          ...
          <td>
			<input type="text" name="ddd" size="2" maxlength="4" style="width:30px;min-width:30px;" value="<?php echo $ddd; ?>" /> 
			<input type="text" name="telephone" value="<?php echo $telephone; ?>" maxlength="9" style="width:90px;"/>
		...
		<tr>
          <td>Celular</td>
          <td>
			<input type="text" name="ddd2" size="2" maxlength="4" style="width:30px;min-width:30px;" value="<?php echo $ddd2; ?>" /> 
