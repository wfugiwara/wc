...
<script type="text/javascript" src="app/braspag/loja5.js"></script>
<?php
...
$option = "";
$option .= "<option value='1'>Pagamento mensal de R$ ".MoedaOk($total_pedido)."</option>";
?>
...
<?php if($ativa_cartao=='sim'){?><a href="#tab-cartao" style="display: inline;">Cart&atilde;o de Cr&eacute;dito</a><?php } ?>
