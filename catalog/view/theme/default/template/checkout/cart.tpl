...
<div id="content"><?php echo $content_top; ?>
    ...
    <div class="cart-info">
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td style="border:none;" class="image"><?php if ($product['thumb']) { ?>
              <a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" /></a>
              <?php } ?></td>
            <td style="border:none;" class="name"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
              ...
              <?php } ?></td>
            <td style="border:none;" class="model"><?php echo $product['model']; ?></td>
            <td style="border:none;" class="quantity"><input type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" />
              &nbsp;
            ...
            <td style="border:none;" class="price"><?php echo $product['price']; ?></td>
            <td style="border:none;" class="total"><?php echo $product['total']; ?></td>
          </tr>
		  ...
		  <tr style="border:none;">
			...
			<h2>Preencha os campos dos renavans abaixo:</h2> 
				...
				for ($i = 1; $i <= $product['quantity']; $i++) { ?>
					 ...
					 <input type="text" name="option<?php echo $j; ?>[]" id="option<?php echo $j.$i; ?>" onFocus="javascript:this.value=''" size="11" onkeypress="return numeros(event.keyCode, event.which);" maxlength="11" value="<?php
  ...
  <div class="cart-module">
    <div id="coupon" class="content" style="display: <?php echo ($next == 'coupon' ? 'block' : 'none'); ?>;">
      <form action="<?php echo $action; ?>" method="post" id="cupom" enctype="multipart/form-data">
        <?php echo $entry_coupon; ?>&nbsp;
        <input type="text" name="coupon" value="<?php echo $coupon; ?>" />
        <input type="hidden" name="next" value="coupon" />
        &nbsp;
        <input type="button" value="<?php echo $button_coupon; ?>" class="button" id="btn_cupom" />
      </form>
    </div>
  ...
  <div class="buttons">
		<div class="right"><a  class="button" id="btn_renavam" ><?php echo $button_checkout; ?></a></div> 
