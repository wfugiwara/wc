...
echo '<br /><p class="valor-parcelamento">ou ' . $qtd_parcelas . 'x de ' . $moeda_da_loja . number_format($valor_parcela, 2, ',', '.');
if ($juros == 0) { echo ' <BR>sem juros</p>'; } else { echo ' <BR>com juros de ' . $juros . '% ao m&ecirc;s</p>'; }
}
?>
