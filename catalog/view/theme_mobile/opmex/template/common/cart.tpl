...
<table class="cart">
  ...
  <tr>
    <td class="image"><?php if ($product['thumb']) { ?>
      <a href="<?php echo $product['href']; ?>" rel="external"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" /></a>
      <?php } ?></td>
    <td class="name"><a href="<?php echo $product['href']; ?>" rel="external"><?php echo $product['name']; ?></a>
      <div>
...
<div class="checkout"><a href="<?php echo $checkout; ?>" class="button" rel="external"><span><?php echo $button_checkout; ?></span></a></div>
<?php } else { ?>
