...
<div data-role="content" style="text-align:center; margin-top:0px; padding-top:0px;" data-theme="a">
<h2 style="margin:5px;"><?php echo $heading_title; ?></h2>
<div class="product-info">
<?php if ($thumb || $images) { ?>
<div class="left" data-theme="a">
  <?php if ($thumb) { ?>
...
<?php echo $text_price; ?>
  ...
  <?php } ?>
      ...
      <fieldset>
      <?php if ($options) { ?>
      <div class="options" data-theme="a">
        <br />
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <select name="option[<?php echo $option['product_option_id']; ?>]" data-theme="a">
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <b><?php echo $option['name']; ?>:</b><br />
          <?php foreach ($option['option_value'] as $option_value) { ?>
          <input type="radio" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>" data-theme="a" />
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <b><?php echo $option['name']; ?>:</b><br />
          <?php foreach ($option['option_value'] as $option_value) { ?>
          <input type="checkbox" name="option[<?php echo $option['product_option_id']; ?>][]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>" data-theme="a" />
          <label for="option-value-<?php echo $option_value['product_option_value_id']; ?>"><?php echo $option_value['name']; ?>
            <?php if ($option_value['price']) { ?>
            (<?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?>)
            <?php } ?>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <?php } ?>
          <b><?php echo $option['name']; ?>:</b><br />
          <input type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['option_value']; ?>" data-role="datebox"
   data-options='{"mode": "calbox"}' />
      ...
      <?php } ?>
      <!--<div class="share" style="margin-left:10px; margin-top:10px;">
        <div class="addthis_default_style" data-theme="a"><a class="addthis_button_compact" ><?php echo $text_share; ?></a> <a class="addthis_button_email"></a><a class="addthis_button_print"></a> <a class="addthis_button_facebook"></a> <a class="addthis_button_twitter"></a></div>
      ...
      <div data-role="collapsible" data-collapsed="true" data-theme="a" data-content-theme="d">
        ...
        <div data-role="fieldcontain">
          ...
          <fieldset data-role="controlgroup">
            <input type="radio" name="rating" id="radio-choice-1" value="1"  data-theme="a"/>
            <label for="radio-choice-1">1</label>
            <input type="radio" name="rating" id="radio-choice-2" value="2"   data-theme="a"/>
            <label for="radio-choice-2">2</label>
            <input type="radio" name="rating" id="radio-choice-3" value="3"   data-theme="a"/>
            <label for="radio-choice-3">3</label>
            <input type="radio" name="rating" id="radio-choice-4" value="4"  data-theme="a" />
            <label for="radio-choice-4">4</label>
            <input type="radio" name="rating" id="radio-choice-5" value="5" checked="checked"  data-theme="a" />
          ...
          <fieldset>
			...
			<a class="button" id="button-review" rel="external" data-role="button" data-theme="a"><span><?php echo $button_continue; ?></span></a>
          </fieldset>
        </div>
      </div>
    <?php } ?>
...
<?php if ($products) { ?>
  <div data-role="collapsible" data-collapsed="true" data-theme="a" data-content-theme="d">
    ...
    <li><a href="<?php echo $product['href']; ?>" rel="external" data-theme="a">
