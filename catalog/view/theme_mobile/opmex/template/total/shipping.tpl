<div data-role="collapsible" data-collapsed="true" id="shipping">
        ...
        <select name="country_id" onchange="refresh_zone();$('select[name=\'zone_id\']').load('index.php?route=total/shipping/zone&country_id=' + this.value + '&zone_id=<?php echo $zone_id; ?>');" data-native-menu="true" data-theme="a">
    ...
    <a id="button-quote" class="button" data-role="button" rel="external" data-theme="a"><?php echo $button_quote; ?></a>
