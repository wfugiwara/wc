  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" data-ajax="false">
    ...
    <select name="country_id" data-native-menu="true"  data-theme="a">
        ...
        <select name="zone_id" class="large-field" data-native-menu="true"  data-theme="a">
          ...
          <?php if ($default) { ?>
            <input type="radio" name="default" value="1" checked="checked" id="choise_yes" data-theme="a"/>
            <label for="choise_yes"><?php echo $text_yes; ?></label>
            <input type="radio" name="default" value="0" id="choise_no" data-theme="a" />
            <label for="choise_no"><?php echo $text_no; ?></label>
            <?php } else { ?>
            <input type="radio" name="default" value="1" id="choise_yes" data-theme="a"/>
            <label for="choise_yes"><?php echo $text_yes; ?></label>
            <input type="radio" name="default" value="0" checked="checked" id="choise_no" data-theme="a"/>
            <label for="choise_no"><?php echo $text_no; ?></label>
            <?php } ?>
            </fieldset>
