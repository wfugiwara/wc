...
<h2 style="margin-top:0px;"><?php echo $heading_title; ?></h2>
 <div class="checkout">
    <div id="checkout">
      ...
      <ul data-role="listview" data-divider-theme="b" style="margin-top:10px; margin-bottom:10px;">
...
$('#button-account').live('click', function() {
	...
	// $.mobile.changePage('index.php?route=account/register', {reloadPage:true, changeHash: false}); 
	$.ajax({
